...
var app = (function () {
  ...
  // (9:8) <Link to="/" class="text-gray-300 font-semibold transition duration-300">
  function create_default_slot_3(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "slot",
  		source: "(9:8) <Link to=\\\"/\\\" class=\\\"text-gray-300 font-semibold transition duration-300\\\">",
  		ctx
  	});
  ...
  // (12:8) <Link to="/portfolio" class="text-gray-300 font-semibold transition duration-300">
  function create_default_slot_2(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "slot",
  		source: "(12:8) <Link to=\\\"/portfolio\\\" class=\\\"text-gray-300 font-semibold transition duration-300\\\">",
  		ctx
  	});
  ...
  // (15:8) <Link to="/about" class="text-gray-300 font-semibold  transition duration-300">
  function create_default_slot_1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "slot",
  		source: "(15:8) <Link to=\\\"/about\\\" class=\\\"text-gray-300 font-semibold  transition duration-300\\\">",
  		ctx
  	});
  ...
  // (18:8) <Link to="/contact" class="text-gray-300 font-semibold transition duration-300">
  function create_default_slot$2(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "slot",
  		source: "(18:8) <Link to=\\\"/contact\\\" class=\\\"text-gray-300 font-semibold transition duration-300\\\">",
  		ctx
  	});
  ...
  function create_fragment$5(ctx) {
  	...
  	link0 = new Link({
  			props: {
  				to: "/",
  				class: "text-gray-300 font-semibold transition duration-300",
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(li0, file$5, 7, 6, 181);
  			add_location(li1, file$5, 10, 6, 300);
  			add_location(li2, file$5, 13, 6, 433);
  			add_location(li3, file$5, 16, 6, 559);
  			attr_dev(ul, "class", "flex space-x-6");
  			add_location(ul, file$5, 6, 4, 146);
  			attr_dev(div, "class", "container mx-auto");
  			add_location(div, file$5, 5, 2, 109);
  			attr_dev(nav, "class", "bg-gray-600 p-4 shadow-lg ");
  			add_location(nav, file$5, 4, 0, 65);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  // (12:2) <Link to="/portfolio" class="text-white rounded-full shadow-lg transition duration-300">
  function create_default_slot$1(ctx) {
  	...
  	dispatch_dev("SvelteRegisterBlock", {
  		...
  		type: "slot",
  		source: "(12:2) <Link to=\\\"/portfolio\\\" class=\\\"text-white rounded-full shadow-lg transition duration-300\\\">",
  		ctx
  	});
  ...
  function create_fragment$4(ctx) {
  	...
  	link = new Link({
  			props: {
  				to: "/portfolio",
  				class: "text-white rounded-full shadow-lg transition duration-300",
  	...
  	const block = {
  		c: function create() {
  			...
  			t1 = space();
  			p = element("p");
  			p.textContent = "Kiel Agustin";
  			t3 = space();
  			p2 = element("p2");
  			p2.textContent = "BSCS 3C";
  			t5 = space();
  			create_component(link.$$.fragment);
  			attr_dev(h1, "class", "text-6xl text-white");
  			add_location(h1, file$4, 8, 2, 346);
  			attr_dev(p, "class", "mt-4 text-xl text-white");
  			add_location(p, file$4, 9, 2, 396);
  			attr_dev(p2, "class", "mt-4 text-2xl text-white");
  			add_location(p2, file$4, 10, 2, 451);
  			attr_dev(main, "class", "flex flex-col items-center justify-center min-h-screen bg-cover bg-center");
  			set_style(main, "background-image", "url('https://e0.pxfuel.com/wallpapers/475/184/desktop-wallpaper-portfolio-background-portfolio-background-portfolio-and-career-portfolio.jpg')");
  			set_style(main, "margin", "0");
  			add_location(main, file$4, 4, 0, 65);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  /* src\routes\Portfolio.svelte generated by Svelte v4.2.19 */
  const file$3 = "src\\routes\\Portfolio.svelte";
  ...
  function create_each_block(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t0 = space();
  			h2 = element("h2");
  			h2.textContent = `${/*project*/ ctx[1].name}`;
  			t2 = space();
  			p = element("p");
  			p.textContent = `${/*project*/ ctx[1].description}`;
  			t4 = space();
  			if (!src_url_equal(img.src, img_src_value = /*project*/ ctx[1].image)) attr_dev(img, "src", img_src_value);
  			attr_dev(img, "alt", /*project*/ ctx[1].name);
  			set_style(img, "width", "128px");
  			set_style(img, "height", "128px");
  			set_style(img, "object-fit", "cover");
  			attr_dev(img, "class", "rounded-t-lg");
  			add_location(img, file$3, 16, 8, 1047);
  			attr_dev(h2, "class", "text-xl font-semibold mt-4");
  			add_location(h2, file$3, 17, 8, 1178);
  			attr_dev(p, "class", "mt-2 text-gray-300");
  			add_location(p, file$3, 18, 8, 1246);
  			attr_dev(li, "class", "bg-gray-400 rounded-lg shadow-md transition-transform transform hover:scale-105 p-4");
  			add_location(li, file$3, 15, 6, 941);
  		},
  		m: function mount(target, anchor) {
  ...
  function create_fragment$3(ctx) {
  	...
  	let t1;
  	let ul;
  	let each_value = ensure_array_like_dev(/*projects*/ ctx[0]);
  	let each_blocks = [];
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(h1, "class", "text-4xl font-bold text-center mb-8");
  			add_location(h1, file$3, 12, 2, 766);
  			attr_dev(ul, "class", "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8");
  			add_location(ul, file$3, 13, 2, 835);
  			attr_dev(main, "class", "p-8 bg-gray-300 min-h-screen");
  			add_location(main, file$3, 11, 0, 719);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  		...
  		p: function update(ctx, [dirty]) {
  			if (dirty & /*projects*/ 1) {
  				each_value = ensure_array_like_dev(/*projects*/ ctx[0]);
  				let i;
  ...
  function instance$3($$self, $$props, $$invalidate) {
  	...
  	let projects = [
  		{
  			name: 'First Pixelated Moving Art',
  			description: 'I made a pixelated moving mario through adobe.',
  			image: '/images/Screenshot 2024-10-10 234830.jpg'
  		},
  		{
  			name: 'First Navigation Bars',
  			description: 'First time i made navigation bars.',
  			image: '/images/Screenshot 2024-10-11 004931.jpg'
  		},
  		{
  			name: 'Shoe Home Page',
  			description: 'This is our first home page, we created a shoe website.',
  			image: 'images/Screenshot 2024-10-11 005441.jpg'
  		},
  		{
  			name: 'Inside Shoe Homepage',
  			description: 'This is the shoes that are inside of the shoe website we made.',
  			image: 'images/Screenshot 2024-10-11 005511.jpg'
  		}
  	];
  ...
  /* src\routes\About.svelte generated by Svelte v4.2.19 */
  ...
  function create_fragment$2(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			t1 = space();
  			p = element("p");
  			p.textContent = "I am Kiel Agustin from BSCS 3C";
  			attr_dev(h1, "class", "text-4xl font-bold text-center mb-4");
  			add_location(h1, file$2, 4, 4, 114);
  			attr_dev(p, "class", "text-lg text-gray-700 text-center max-w-2xl mx-auto");
  			add_location(p, file$2, 5, 4, 181);
  			attr_dev(main, "class", "p-8 bg-gray-200 min-h-screen");
  ...
  function create_fragment$1(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			attr_dev(h1, "class", "text-4xl font-bold text-center mb-4");
  			add_location(h1, file$1, 15, 4, 360);
  			attr_dev(input0, "type", "text");
  			attr_dev(input0, "placeholder", "Name");
  			attr_dev(input0, "class", "border border-gray-300 p-2 w-full rounded focus:outline-none focus:ring focus:ring-blue-500");
  			input0.required = true;
  			add_location(input0, file$1, 17, 6, 552);
  			attr_dev(input1, "type", "email");
  			attr_dev(input1, "placeholder", "Email");
  			attr_dev(input1, "class", "border border-gray-300 p-2 w-full rounded focus:outline-none focus:ring focus:ring-blue-500");
  			input1.required = true;
  			add_location(input1, file$1, 18, 6, 725);
  			attr_dev(textarea, "placeholder", "Message");
  			attr_dev(textarea, "class", "border border-gray-300 p-2 w-full rounded focus:outline-none focus:ring focus:ring-blue-500");
  			textarea.required = true;
  			add_location(textarea, file$1, 19, 6, 901);
  			attr_dev(button, "type", "submit");
  			attr_dev(button, "class", "bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 transition");
  			add_location(button, file$1, 20, 6, 1082);
  			attr_dev(form, "class", "max-w-md mx-auto bg-white p-6 rounded-lg shadow-lg space-y-4");
  			add_location(form, file$1, 16, 4, 429);
  			attr_dev(main, "class", "p-8 bg-gray-100 min-h-screen");
  			add_location(main, file$1, 14, 2, 311);
  		},
  		l: function claim(nodes) {
  			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
  		},
  ...
  function instance$1($$self, $$props, $$invalidate) {
  	...
  	$$self.$capture_state = () => ({ Link, name, email, message, handleSubmit });
  ...
  function create_default_slot(ctx) {
  	...
  	const block = {
  		c: function create() {
  			...
  			add_location(main, file, 11, 1, 324);
  		},
  		m: function mount(target, anchor) {
